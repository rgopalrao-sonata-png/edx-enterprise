...
class TestAdminInviteUtils(TestCase):
    ...
    def test_get_existing_admin_emails_excludes_inactive_users(self):
        """Test inactive enterprise users and inactive auth users are excluded."""
        ...
        assert inactive_auth_user.email.lower() not in emails
    ...
    def test_create_pending_invites_handles_exception(self, _mock_delay):
        ...
        # Simulate exception while creating pending invite
        with patch(
