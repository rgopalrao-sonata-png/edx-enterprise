...
class TestAdminInviteStatus:
    ...
    def test_inactive_admin_status(self):
        """Test INACTIVE_ADMIN status is correctly defined."""
        assert AdminInviteStatus.INACTIVE_ADMIN == 'inactive admin'

    def test_admin_role_removed_status(self):
        """Test ADMIN_ROLE_REMOVED status is correctly defined."""
        assert AdminInviteStatus.ADMIN_ROLE_REMOVED == 'admin role removed'
    ...
    def test_all_statuses_are_strings(self):
        ...
        statuses = [
            ...
            AdminInviteStatus.INACTIVE_ADMIN,
            AdminInviteStatus.ADMIN_ROLE_REMOVED,
        ]
